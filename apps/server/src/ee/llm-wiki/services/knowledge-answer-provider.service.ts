...
function buildSystemPrompt(
  ...
  return [
    ...
    'When the provided evidence is insufficient or unrelated, output exactly [[answer:general]] and nothing else except the required <general_reason>...</general_reason> tag.',
...
function buildGeneralSystemPrompt(): string {
  ...
  return [
    ...
    'Begin with <general_reason>...</general_reason>, then provide the answer.',
